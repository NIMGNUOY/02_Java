...
public class Member {
	...
	// 메서드
	// getter / setter 
	// 다른 패키지에서도 접근 가능하도록 public
	public String getMemberId() {
		// 반환형 : String 자료형을 돌려보내겠다.
		return memberId; // 매개변수가 없어서 중복된 memberId가 없기 때문에
						 // 그냥 memberId라고만 써도 가능!
	}

	// 반환형 : void 반환값이 없다. 단순히 전달받은 매개변수를 세팅
	public void setMemberId(String memberId) {
		...
		// 단, void 일 경우 생략 가능 -> 생략 시 컴파일러가 자동추가
	}
