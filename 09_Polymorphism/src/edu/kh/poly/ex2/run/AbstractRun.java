...
import edu.kh.poly.ex2.model.service.SYMCalculator;
...
public class AbstractRun {
	...
	public static void main(String[] args) {
		...
		//Calculator cal = new SYMCalculator();
