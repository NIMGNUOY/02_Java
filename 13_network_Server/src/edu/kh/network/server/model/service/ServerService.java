...
public class ServerService {
	 ...
	 * 
	 * - 데이터 전송 순서가 보장되고,
	 *   수신 여부를 판단하여 오류(데이터 손실) 발생 시 재전송
	 * 
	 * * java.net 패키지에서 제공하는
	 *   Socket, ServerSocket 클래스를 사용해야함
	 *   
	 *   Socket 
	 * - 프로세스의 양 끝단(프로세스 간의 통신을 담당)
	 * - Input / OutputStream 보유하고 있다.
	 * 
	 * 	 ServerSocket
	...
	public void serverStart() {
		...
		try {
			...
			Date now = new Date();			// new Date() 로 객체 생성 시 현재 시간이 저장되어 있다.
